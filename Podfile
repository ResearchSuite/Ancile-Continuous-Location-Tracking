...
target 'AncileContinuousLocationStudy' do
  ...
  pod "ResearchSuiteResultsProcessor/CSVBackend", :git => 'https://github.com/ResearchSuite/ResearchSuiteResultsProcessor-ios', :tag => '0.8.0'
