...
open class ANCClient: NSObject {
    ...
    static open let kAncileAuthToken = "ancile_study_server_auth_token"
    ...
    open var ancileAuthDelegate: ANCAncileAuthDelegate!
    open var coreAuthDelegate: ANCCoreAuthDelegate!
    
    fileprivate var _authToken: String?
